    ...
    return (
        ...
        <div class="flex flex-col items-center">
            <div class="text-center">
                <h2 class="mt-4 text-3xl font-bold text-[#021100] sm:text-4xl xl:text-5xl font-pj">Our happy clients say about us</h2>
            </div>
            <div class="relative mt-10 md:mt-24 md:order-2">
                ...
                <div class="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                    <div class="flex flex-col overflow-hidden rounded-2xl shadow-xl">
                        <div class="flex flex-col justify-between flex-1 p-6 bg-[#DBF6D7] rounded-2xl lg:py-8 lg:px-7">
                            <div class="flex-1">
                    ...
                    <div class="flex flex-col rounded-2xl overflow-hidden shadow-xl">
                        <div class="flex flex-col justify-between flex-1 rounded-2xl p-6 bg-[#DBF6D7] lg:py-8 lg:px-7">
                            <div class="flex-1">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-[#FDB241]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path
